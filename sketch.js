...
function preload(){
    ...
    studentImage = loadImage("images/student.gif");//student image loading
    groundImage = loadImage("images/ground.png");//ground image loading
    house_1 = loadImage("images/house1.jpg"); //loading house - 1
    house_2 = loadImage("images/house2.png");//loading house - 2
    house_3 = loadImage("images/house3.jpg");//loading house - 3
    house_4 = loadImage("images/house4.png");//loading house - 4
    schoolImage = loadImage("images/school.jpg");//loading the school
    cloudImage = loadImage("images/cloud.jpg");//loading cloud
    bushImage = loadImage("images/bush.png");//loading bush
    obstacleImage1 = loadImage("images/obstacle1.png");//loading obstacle - 1
}
